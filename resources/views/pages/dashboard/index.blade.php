			...
			<div class="col-12">
				<div class="card">
					...
					<div class="card-body">
						<div class="row">
							<div class="col-4">
								<code class="d-flex justify-content-center align-items-center text-dark">Persentase Per Bidang</code>
								<div id="chart-activity-by-department"></div>
							</div>
							<div class="col-8">
							<code class="d-flex justify-content-center align-items-center text-dark">Per Bulan</code>
...
@push('scripts')
    ...
    // Ambil hanya aktivitas dengan status "Selesai"
    const activitiesData = response.data.filter(activity => activity.status === "Selesai");
